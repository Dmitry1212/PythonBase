...
# деление клеток, соответственно. В методе деления должно осуществляться округление значения
# до целого числа.
...
class Cell:
    ...
    def __sub__(self, other):
        return self.cnt - other.cnt if self.cnt > other.cnt else 'Не хватает клеток для вычитания'
...
print(f'В клетке 1 содержится {cell_1} ячеек')
print(f'В клетке 2 содержится {cell_2} ячеек')
print('*' * 30)

print(f'Сложение: {cell_1 + cell_2 + cell_1}')
print(f'Вычитаение {cell_2} из {cell_1}: {cell_1 - cell_2}')
print(f'Вычитаение {cell_1} из {cell_2}: {cell_2 - cell_1}')
print(f'Умножение: {cell_1 * cell_2}')
print(f'Деление целочисленное: {cell_1 // cell_2}')

print(f'{cell_1.make_order(4)}')
